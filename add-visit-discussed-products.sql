...
-- This table links visits to the products that were discussed during the meeting

CREATE TABLE IF NOT EXISTS visit_discussed_products (
...
CREATE INDEX IF NOT EXISTS idx_visit_discussed_products_visit_id ON visit_discussed_products(visit_id);
CREATE INDEX IF NOT EXISTS idx_visit_discussed_products_product_id ON visit_discussed_products(product_id);
